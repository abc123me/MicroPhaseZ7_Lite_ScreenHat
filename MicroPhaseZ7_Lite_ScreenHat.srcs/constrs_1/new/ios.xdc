...
###################################################################
set_property -dict {PACKAGE_PIN N17 IOSTANDARD LVCMOS33} [get_ports ILI_0_sda]
set_property -dict {PACKAGE_PIN R16 IOSTANDARD LVCMOS33} [get_ports ILI_1_sda]
set_property -dict {PACKAGE_PIN T16 IOSTANDARD LVCMOS33} [get_ports ILI_2_sda]
set_property -dict {PACKAGE_PIN W18 IOSTANDARD LVCMOS33} [get_ports ILI_3_sda]
set_property -dict {PACKAGE_PIN Y18 IOSTANDARD LVCMOS33} [get_ports ILI_4_sda]
set_property -dict {PACKAGE_PIN Y16 IOSTANDARD LVCMOS33} [get_ports ILI_5_sda]
set_property -dict {PACKAGE_PIN V17 IOSTANDARD LVCMOS33} [get_ports ILI_6_sda]
set_property -dict {PACKAGE_PIN W14 IOSTANDARD LVCMOS33} [get_ports ILI_7_sda]
set_property -dict {PACKAGE_PIN V16 IOSTANDARD LVCMOS33} [get_ports ILI_8_sda]
set_property -dict {PACKAGE_PIN T17 IOSTANDARD LVCMOS33} [get_ports ILI_9_sda]
set_property -dict {PACKAGE_PIN V12 IOSTANDARD LVCMOS33} [get_ports ILI_A_sda]
set_property -dict {PACKAGE_PIN T14 IOSTANDARD LVCMOS33} [get_ports ILI_B_sda]
set_property -dict {PACKAGE_PIN T11 IOSTANDARD LVCMOS33} [get_ports ILI_C_sda]
set_property -dict {PACKAGE_PIN V15 IOSTANDARD LVCMOS33} [get_ports ILI_D_sda]

# ILI9341 Display CLK lines
###################################################################
set_property -dict {PACKAGE_PIN P18 IOSTANDARD LVCMOS33} [get_ports ILI_0_scl]
set_property -dict {PACKAGE_PIN R17 IOSTANDARD LVCMOS33} [get_ports ILI_1_scl]
set_property -dict {PACKAGE_PIN U17 IOSTANDARD LVCMOS33} [get_ports ILI_2_scl]
set_property -dict {PACKAGE_PIN W19 IOSTANDARD LVCMOS33} [get_ports ILI_3_scl]
set_property -dict {PACKAGE_PIN Y19 IOSTANDARD LVCMOS33} [get_ports ILI_4_scl]
set_property -dict {PACKAGE_PIN Y17 IOSTANDARD LVCMOS33} [get_ports ILI_5_scl]
set_property -dict {PACKAGE_PIN V18 IOSTANDARD LVCMOS33} [get_ports ILI_6_scl]
set_property -dict {PACKAGE_PIN Y14 IOSTANDARD LVCMOS33} [get_ports ILI_7_scl]
set_property -dict {PACKAGE_PIN W16 IOSTANDARD LVCMOS33} [get_ports ILI_8_scl]
set_property -dict {PACKAGE_PIN R18 IOSTANDARD LVCMOS33} [get_ports ILI_9_scl]
set_property -dict {PACKAGE_PIN W13 IOSTANDARD LVCMOS33} [get_ports ILI_A_scl]
set_property -dict {PACKAGE_PIN T15 IOSTANDARD LVCMOS33} [get_ports ILI_B_scl]
set_property -dict {PACKAGE_PIN T10 IOSTANDARD LVCMOS33} [get_ports ILI_C_scl]
set_property -dict {PACKAGE_PIN W15 IOSTANDARD LVCMOS33} [get_ports ILI_D_scl]
...
###################################################################
set_property -dict {PACKAGE_PIN G15 IOSTANDARD LVCMOS33} [get_ports rst595_resetn]
set_property -dict {PACKAGE_PIN H15 IOSTANDARD LVCMOS33} [get_ports rst595_latch]
set_property -dict {PACKAGE_PIN L16 IOSTANDARD LVCMOS33} [get_ports rst595_clock]
set_property -dict {PACKAGE_PIN L17 IOSTANDARD LVCMOS33} [get_ports rst595_data]

# 74HC595 shift register driver - Channel 2 backlights
###################################################################
set_property -dict {PACKAGE_PIN U15 IOSTANDARD LVCMOS33} [get_ports led595_resetn]
set_property -dict {PACKAGE_PIN U14 IOSTANDARD LVCMOS33} [get_ports led595_latch]
set_property -dict {PACKAGE_PIN P14 IOSTANDARD LVCMOS33} [get_ports led595_clock]
set_property -dict {PACKAGE_PIN R14 IOSTANDARD LVCMOS33} [get_ports led595_data]

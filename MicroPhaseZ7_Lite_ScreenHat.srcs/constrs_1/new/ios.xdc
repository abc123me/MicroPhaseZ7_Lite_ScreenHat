...
set spi_period      16.667
set lcd_setup_ns     10.0
set lcd_hold_ns      10.0
set board_skew_ns     2.0

create_generated_clock -name ILI_0_CLK -source [get_clocks clk_fpga_1] -divide_by 1  [get_ports ILI_0_scl]
set_output_delay -clock ILI_0_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_0_sda]
set_output_delay -clock ILI_0_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_0_sda]
set_output_delay -clock ILI_0_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_0_cs]
set_output_delay -clock ILI_0_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_0_cs]
set_output_delay -clock ILI_0_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_0_dc]
set_output_delay -clock ILI_0_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_0_dc]

create_generated_clock -name ILI_1_CLK -source [get_clocks clk_fpga_1] -divide_by 1  [get_ports ILI_1_scl]
set_output_delay -clock ILI_1_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_1_sda]
set_output_delay -clock ILI_1_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_1_sda]
set_output_delay -clock ILI_1_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_1_cs]
set_output_delay -clock ILI_1_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_1_cs]
set_output_delay -clock ILI_1_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_1_dc]
set_output_delay -clock ILI_1_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_1_dc]

create_generated_clock -name ILI_2_CLK -source [get_clocks clk_fpga_1] -divide_by 1  [get_ports ILI_2_scl]
set_output_delay -clock ILI_2_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_2_sda]
set_output_delay -clock ILI_2_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_2_sda]
set_output_delay -clock ILI_2_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_2_cs]
set_output_delay -clock ILI_2_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_2_cs]
set_output_delay -clock ILI_2_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_2_dc]
set_output_delay -clock ILI_2_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_2_dc]

create_generated_clock -name ILI_3_CLK -source [get_clocks clk_fpga_1] -divide_by 1  [get_ports ILI_3_scl]
set_output_delay -clock ILI_3_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_3_sda]
set_output_delay -clock ILI_3_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_3_sda]
set_output_delay -clock ILI_3_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_3_cs]
set_output_delay -clock ILI_3_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_3_cs]
set_output_delay -clock ILI_3_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_3_dc]
set_output_delay -clock ILI_3_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_3_dc]

create_generated_clock -name ILI_4_CLK -source [get_clocks clk_fpga_1] -divide_by 1  [get_ports ILI_4_scl]
set_output_delay -clock ILI_4_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_4_sda]
set_output_delay -clock ILI_4_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_4_sda]
set_output_delay -clock ILI_4_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_4_cs]
set_output_delay -clock ILI_4_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_4_cs]
set_output_delay -clock ILI_4_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_4_dc]
set_output_delay -clock ILI_4_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_4_dc]

create_generated_clock -name ILI_5_CLK -source [get_clocks clk_fpga_1] -divide_by 1  [get_ports ILI_5_scl]
set_output_delay -clock ILI_5_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_5_sda]
set_output_delay -clock ILI_5_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_5_sda]
set_output_delay -clock ILI_5_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_5_cs]
set_output_delay -clock ILI_5_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_5_cs]
set_output_delay -clock ILI_5_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_5_dc]
set_output_delay -clock ILI_5_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_5_dc]

create_generated_clock -name ILI_6_CLK -source [get_clocks clk_fpga_1] -divide_by 1  [get_ports ILI_6_scl]
set_output_delay -clock ILI_6_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_6_sda]
set_output_delay -clock ILI_6_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_6_sda]
set_output_delay -clock ILI_6_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_6_cs]
set_output_delay -clock ILI_6_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_6_cs]
set_output_delay -clock ILI_6_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_6_dc]
set_output_delay -clock ILI_6_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_6_dc]

create_generated_clock -name ILI_7_CLK -source [get_clocks clk_fpga_1] -divide_by 1  [get_ports ILI_7_scl]
set_output_delay -clock ILI_7_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_7_sda]
set_output_delay -clock ILI_7_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_7_sda]
set_output_delay -clock ILI_7_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_7_cs]
set_output_delay -clock ILI_7_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_7_cs]
set_output_delay -clock ILI_7_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_7_dc]
set_output_delay -clock ILI_7_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_7_dc]

create_generated_clock -name ILI_8_CLK -source [get_clocks clk_fpga_1] -divide_by 1  [get_ports ILI_8_scl]
set_output_delay -clock ILI_8_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_8_sda]
set_output_delay -clock ILI_8_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_8_sda]
set_output_delay -clock ILI_8_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_8_cs]
set_output_delay -clock ILI_8_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_8_cs]
set_output_delay -clock ILI_8_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_8_dc]
set_output_delay -clock ILI_8_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_8_dc]

create_generated_clock -name ILI_9_CLK -source [get_clocks clk_fpga_1] -divide_by 1  [get_ports ILI_9_scl]
set_output_delay -clock ILI_9_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_9_sda]
set_output_delay -clock ILI_9_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_9_sda]
set_output_delay -clock ILI_9_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_9_cs]
set_output_delay -clock ILI_9_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_9_cs]
set_output_delay -clock ILI_9_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_9_dc]
set_output_delay -clock ILI_9_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_9_dc]

create_generated_clock -name ILI_A_CLK -source [get_clocks clk_fpga_1] -divide_by 1  [get_ports ILI_A_scl]
set_output_delay -clock ILI_A_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_A_sda]
set_output_delay -clock ILI_A_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_A_sda]
set_output_delay -clock ILI_A_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_A_cs]
set_output_delay -clock ILI_A_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_A_cs]
set_output_delay -clock ILI_A_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_A_dc]
set_output_delay -clock ILI_A_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_A_dc]

create_generated_clock -name ILI_B_CLK -source [get_clocks clk_fpga_1] -divide_by 1  [get_ports ILI_B_scl]
set_output_delay -clock ILI_B_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_B_sda]
set_output_delay -clock ILI_B_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_B_sda]
set_output_delay -clock ILI_B_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_B_cs]
set_output_delay -clock ILI_B_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_B_cs]
set_output_delay -clock ILI_B_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_B_dc]
set_output_delay -clock ILI_B_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_B_dc]

create_generated_clock -name ILI_C_CLK -source [get_clocks clk_fpga_1] -divide_by 1  [get_ports ILI_C_scl]
set_output_delay -clock ILI_C_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_C_sda]
set_output_delay -clock ILI_C_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_C_sda]
set_output_delay -clock ILI_C_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_C_cs]
set_output_delay -clock ILI_C_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_C_cs]
set_output_delay -clock ILI_C_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_C_dc]
set_output_delay -clock ILI_C_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_C_dc]

create_generated_clock -name ILI_D_CLK -source [get_clocks clk_fpga_1] -divide_by 1  [get_ports ILI_D_scl]
set_output_delay -clock ILI_D_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_D_sda]
set_output_delay -clock ILI_D_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_D_sda]
set_output_delay -clock ILI_D_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_D_cs]
set_output_delay -clock ILI_D_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_D_cs]
set_output_delay -clock ILI_D_CLK -max [expr {$lcd_setup_ns + $board_skew_ns}]       [get_ports ILI_D_dc]
set_output_delay -clock ILI_D_CLK -min [expr {-1 * ($lcd_hold_ns + $board_skew_ns)}] [get_ports ILI_D_dc]

set_input_delay  -clock clk_fpga_0 -min -0.1 [get_ports {ETH_MII_rxd[3]}]
set_input_delay  -clock clk_fpga_0 -min -0.1 [get_ports {ETH_MII_rxd[2]}]
set_input_delay  -clock clk_fpga_0 -min -0.1 [get_ports {ETH_MII_rxd[1]}]
set_input_delay  -clock clk_fpga_0 -min -0.1 [get_ports {ETH_MII_rxd[0]}]
set_input_delay  -clock clk_fpga_0 -min -0.2 [get_ports ETH_MII_rx_dv]
set_output_delay -clock clk_fpga_0 -min -0.2 [get_ports ETH_MII_rx_clk]
set_input_delay  -clock clk_fpga_0 -max 0.1  [get_ports {ETH_MII_rxd[3]}]
set_input_delay  -clock clk_fpga_0 -max 0.1  [get_ports {ETH_MII_rxd[2]}]
set_input_delay  -clock clk_fpga_0 -max 0.1  [get_ports {ETH_MII_rxd[1]}]
set_input_delay  -clock clk_fpga_0 -max 0.1  [get_ports {ETH_MII_rxd[0]}]
set_input_delay  -clock clk_fpga_0 -max 0.2  [get_ports ETH_MII_rx_dv]
set_output_delay -clock clk_fpga_0 -max 0.2  [get_ports ETH_MII_rx_clk]

set_output_delay -clock clk_fpga_0 -min -0.1 [get_ports {ETH_MII_txd[3]}]
set_output_delay -clock clk_fpga_0 -min -0.1 [get_ports {ETH_MII_txd[2]}]
set_output_delay -clock clk_fpga_0 -min -0.1 [get_ports {ETH_MII_txd[1]}]
set_output_delay -clock clk_fpga_0 -min -0.1 [get_ports {ETH_MII_txd[0]}]
set_output_delay -clock clk_fpga_0 -min -0.2 [get_ports ETH_MII_tx_clk]
set_output_delay -clock clk_fpga_0 -min -0.2 [get_ports ETH_MII_tx_en]
set_output_delay -clock clk_fpga_0 -max 0.1  [get_ports {ETH_MII_txd[3]}]
set_output_delay -clock clk_fpga_0 -max 0.1  [get_ports {ETH_MII_txd[2]}]
set_output_delay -clock clk_fpga_0 -max 0.1  [get_ports {ETH_MII_txd[1]}]
set_output_delay -clock clk_fpga_0 -max 0.1  [get_ports {ETH_MII_txd[0]}]
set_output_delay -clock clk_fpga_0 -max 0.2  [get_ports ETH_MII_tx_clk]
set_output_delay -clock clk_fpga_0 -max 0.2  [get_ports ETH_MII_tx_en]
